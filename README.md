...
graph TD
    ...
    subgraph "Knowledge Base (90 volumes)"
    E -.-> I[Дневники / Биография]
    E -.-> J[Письма]
    E -.-> K[Философия / Трактаты]
    end
```
...
3. **Source-Aware Memory (Nuclear Filter)**: Внедрена классификация источников (BIOGRAPHY vs PHILOSOPHY), позволяющая системе отказываться от ответов на личные вопросы, если в памяти есть только философские труды.
